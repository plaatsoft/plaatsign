...
function getRssItem($xml, $element) {
	...
	$content['date'] = date("d-m-Y", strtotime(strip_tags((string) $item[$element])));

	$item  = $xml->xpath('/rss/channel/item/category');
	$content['category'] = strtolower(strip_tags((string) $item[$element]));
	
	$item  = $xml->xpath('/rss/channel/item/dc:creator');
	$content['creator'] = strtolower(strip_tags((string) $item[$element]));
